...
SET ID_BAIRRO=5, ID_CIDADE=3, LOGRADOURO='Rua Presida', NUMERO=21, COMPLEMENTO='Do lado de Lelezin'
WHERE ID_ENDERECO=2

UPDATE VEM_SER.ENDERECO
SET LOGRADOURO='Avenida Sal sem Açúcar', NUMERO=1574, COMPLEMENTO='Apt'
WHERE ID_ENDERECO=3
...
DELETE FROM VEM_SER.ENDERECO
WHERE ID_ENDERECO=30

DELETE FROM VEM_SER.ENDERECO
WHERE ID_ENDERECO=18
...
FROM PESSOA P
INNER JOIN 
	CONTATO c ON P.ID_PESSOA = c.ID_CONTATO
