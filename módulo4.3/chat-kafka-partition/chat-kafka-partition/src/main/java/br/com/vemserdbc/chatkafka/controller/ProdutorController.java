...
//    }
    ...
    @PostMapping("/enviar-partitions")
    public ResponseEntity<Void> enviarMensagem(@RequestBody String mensagem, @RequestParam List<EnvioEnum> envio) throws JsonProcessingException {
        produtorService.enviarMensagemPartition(mensagem, envio);
        return new ResponseEntity<>(HttpStatus.CREATED);
    }
}
